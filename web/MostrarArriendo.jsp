    ...
    <form action="Servlet_Usu" method="post" id="frmCabecera">
        ...
        <table id="tablaCabecera">
                            ...
                            <div class="content">
                                    ...
                                    <div class="cover-carousel">
                                        ...
                                        <div class="cover-carousel-item">
                                            <div class="cover-image"
                                                  style="background-image: url('assets/img/slider/7d8c3f27c4c456cd162b1218d4e4538c.jpg')">


                                                <h1 style="color: white;margin: 155px 0px 0 216px;">Arriendos</h1>
                                            </div>
                                            <!-- /.cover-image -->
                                ...
                                <div class="information-bar">
                                    <div class="container">
                                        ...
                                        <i class="fa fa-soccer-ball-o"> <a  href="CuentaAdministrador.jsp" class="link"><span style="color: white">REGRESAR</span></a>
                                        </i>
                                    </div><!-- /.container -->
                                </div><!-- /.information-bar -->
            ...
            <form id="frmMostrarCuerpoVenta">
                ...
                <table id="tablaMostrarCuerpoVenta" style="margin: -751px 0px 0px 213px;  position: absolute;background-color: white  ">
                    ...
                    <%
                        ...
                        ArrayList<Arriendo> lista = Arriendo_DB.ObtenerArriendo();
                        for (int i = 0; i < lista.size(); i++) {
                            Arriendo v = lista.get(i);
                    %>
                    ...
                    <tr>
                        ...
                        <td class="Opcion">
                            <input type="button" name="btnDetalle" id="btnDetalle" class="button" value="Detalle Arriendo" onclick="location.href = 'Servlet_Arriendo?codigoA=<%=v.getCodigoArriendo()%>&&cliente=<%=v.getCliente()%>&&importe=<%=v.getTotal()%>&&FechaV=<%=v.getFecha()%>&&codigoCli=<%=v.getCodigoCliente()%>&&accion=MostrarDetalle'">
                        </td>
                        <td class="Opcion">
                            <input type="button" name="btnEliminar" id="btnEliminar" class="button" value="Eliminar" onclick="location.href = 'Servlet_Arriendo?codigoA=<%=v.getCodigoArriendo()%>&&accion=EliminaArriendo'"> 
                        </td>
                    </tr>
