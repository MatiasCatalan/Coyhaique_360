...
<html>
    <head>
        ...
        <script type="text/javascript" src="js/ModificarCancha.js"></script>
    ...
    <body onload="cargar()">
        ...
        <form action="Servlet_Usu" method="post" id="frmCabecera">
            ...
            <table id="tablaCabecera">
                ...
                <form name="frm" action="Servlet_Cancha" method="post" id="frmModificarProd">
                    <table id="tablaModificarProd">
                        ...
                        <tr>
                            <td colspan="2">
                                <input type="hidden" name="txtCodigo" value="<%=c.getCodigoC()%>">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                        <dd> <input type="text" name="txtNombreCC" id="txtNombreCP" value="<%=c.getClaseCancha()%>" size="30" maxlength="30"> </dd>
                        </td>
                        </tr>
                        <tr>
                            <td class="primeraColumna">
                            ...
                            <td>
                        <dd> <input type="text" name="txtNombreSC" id="txtNombreMP" value="<%=c.getSueloCancha()%>" size="30" maxlength="30"> </dd>
                        </td>
                        </tr>
                        <tr>
                            <td class="primeraColumna">
                            ...
                            <td>
                        <dd> <input type="text" name="txtDescripcionC" id="txtDescripcionP" value="<%=c.getDescripcion()%>" size="30" maxlength="30"> </dd>
                        </td>
                        </tr>
                        <tr>
                            <td class="primeraColumna">
                            ...
                            <td>
                        <dd> <input type="text" name="txtPrecioC" id="txtPrecioP" value="<%=c.getPrecioC()%>" size="30" maxlength="30"> </dd>
                        </td>
                        </tr>
                        <tr>
                            <td class="primeraColumna">
                        ...
                        <dd> <input type="radio" name="selected" value="SelectImagenActual" id="SelectImagenActual" checked="checked"> 
                            <input type="text" name="txtImagen" id="txtImagen" value="<%=c.getImagenC()%>" size="30" maxlength="30"> </dd>
                        </td>
                        </tr>
                        <tr>
                            <td class="primeraColumna">
