...
public class Servlet_Usu extends HttpServlet {
    ...
    private void RegistrarUsuario(HttpServletRequest request, HttpServletResponse response)
        ...
        usu.setCiudadUsuario(Ciudad);
        usu.setRegionUsuario(Region);
        usu.setPaisUsuario(Pais);
    ...
    private void ModificarUsuario(HttpServletRequest request, HttpServletResponse response)
        ...
        usu.setCiudadUsuario(request.getParameter("txtCiudad"));
        usu.setRegionUsuario(request.getParameter("txtRegion"));
        usu.setPaisUsuario(request.getParameter("txtPais"));
