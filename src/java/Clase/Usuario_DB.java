...
public class Usuario_DB {
    ...
    public static boolean RegistrarUsuario(Usuario usu){
        ...
        try{
            ...
            cs.setString(5, usu.getCiudadUsuario());
            cs.setString(6, usu.getRegionUsuario());
            cs.setString(7, usu.getPaisUsuario());
    ...
    public static Usuario listarUsuarioPorCodigo(String codigo){
        ...
        try{
            ...
            while(rs.next()){
                ...
                usu.setDniUsuario(rs.getString("Dni_U"));
                usu.setEmailUsuario(rs.getString("Email_U"));
                usu.setCiudadUsuario(rs.getString("Ciudad_U"));
                usu.setRegionUsuario(rs.getString("Region_U"));
                usu.setPaisUsuario(rs.getString("Pais_U"));
